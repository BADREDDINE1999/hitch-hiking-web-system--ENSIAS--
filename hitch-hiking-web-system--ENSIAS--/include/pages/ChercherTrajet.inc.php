...
if (empty($_POST['vil_num']) && empty($_POST['vil_num2'])) {
  ...
  <!--               <div class="row form-group">
   ...
   /*$resultats = $proposeManager->getResultParcours($_SESSION['vil_num'], $_POST['vil_num2'], $_POST['pro_date'],intval($_POST['pro_date_prec']), $_POST['pro_time']);*/
    ...
    $resultats = $proposeManager->getResultParcours($_SESSION['vil_num'], $_POST['vil_num2'], $_POST['pro_date'],$_POST['pro_time']);
    ...
    <table class="table sortable">
     ...
     <p> Vous devez contacter le conducteur téléphoniquement en passant vers la liste des utilisateurs puis en cliquant sur le numéro d'utilisateur correspondant à ce conducteur et vous allez se retrouver dans la page des informations de ce conducteur </p>
