...
<html>
    ...
    <body>
        <div class="navbar navbar-fixed-top" style="background-color: #81dc5a;">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    if (!isConnected()) {
                    ?>
                    <li><a href="index.php?page=11" class="btn btn-link">se connecter</a></li>
                    <?php
                    } else {
                    ?>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="index.php?page=2&amp;user=<?php echo $_SESSION['user_num'] ?>">Consulter mon profil</a></li>
                        <li class="divider"></li>
                        <li><a href="index.php?page=5">Insérer un parcours</a></li>
                        <li><a href="index.php?page=7">Insérer une ville</a></li>
                        <li><a href="index.php?page=9">Proposer un trajet</a></li>
                        <li class="divider"></li>
                        <li><a href="index.php?page=12">se déconnecter</a></li>
                      </ul>
                    </li>
                    <?php
                    }
